...
export default function NigeriaToAbroadForm() {
  ...
  const onSubmit = (data: NigeriaToAbroadFormData) => {
    ...
    console.log(
      "Uploaded File:",
      finalData.uploadImage?.[0]?.name ?? "No file",
    );
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div>
        ...
        <div className="mb-3">
          ...
          <input
            ...
            className={inputClass}
          />
          {errors.valuesOfGoods && (
            <p className={errorClass}>{errors.valuesOfGoods.message}</p>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          {errors.packageKg && (
            <p className={errorClass}>{errors.packageKg.message}</p>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          {errors.selectHub && (
            <p className={errorClass}>{errors.selectHub.message}</p>
          )}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="mb-3">
          ...
          {errors.receiverAddressLine1 && (
            <p className={errorClass}>{errors.receiverAddressLine1.message}</p>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          {errors.receiverPostalCode && (
            <p className={errorClass}>{errors.receiverPostalCode.message}</p>
          )}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="mb-3">
          ...
          {errors.pickupSelectHub && (
            <p className={errorClass}>{errors.pickupSelectHub.message}</p>
          )}
        </div>
