...
export default function InternationalForm() {
  ...
  const onSubmit = (data: AbroadToInternationalData) => {
    toast.success("Quote Request sent successfully! Get back to reply soon.");
  };
      ...
      <div>
        ...
        <div className="mb-3">
          ...
          {errors.senderCountry && (
            <p className={errorClass}>{errors.senderCountry.message}</p>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          {errors.pickUpServices && (
            <p className={errorClass}>{errors.pickUpServices.message}</p>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          <select
            {...register("whatPickingUp", { required: "Required" })}
            className={inputClass}
          >
          ...
          {errors.whatPickingUp && (
            <p className={errorClass}>{errors.whatPickingUp.message}</p>
          )}
        </div>
        ...
        {whatPickingUp === "others" && (
          <div className="mb-3">
            ...
            <input
              {...register("otherWhatPickingUp", {
                required: whatPickingUp === "others" ? "Required" : false,
              })}
              placeholder="Specify what we are picking up..."
              className={inputClass}
            />
            {errors.otherWhatPickingUp && (
              <p className={errorClass}>{errors.otherWhatPickingUp.message}</p>
            )}
          </div>
        )}
        ...
        <div className="mb-3">
          ...
          <select
            {...register("shippingType", { required: "Required" })}
            className={inputClass}
          >
            <option value="">Select</option>
          ...
          {errors.shippingType && (
            <p className={errorClass}>{errors.shippingType.message}</p>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          />
          {errors.packageValue && (
            <p className={errorClass}>{errors.packageValue.message}</p>
          )}
          {selectedSenderCountry && (
            <p className="text-xs text-gray-400 mt-1">
              {packageUnit === "KG" && "Kilograms — standard unit"}
              {packageUnit === "CBM" &&
                "Cubic Meter — used for China shipments"}
      ...
      <div>
        ...
        <div className="mb-3">
          ...
          {errors.receiverCountry && (
            <p className={errorClass}>{errors.receiverCountry.message}</p>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          {errors.receiverFullName && (
            <p className={errorClass}>{errors.receiverFullName.message}</p>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          {errors.receiverPhone && (
            <p className={errorClass}>{errors.receiverPhone.message}</p>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          {errors.receiverEmail && (
            <p className={errorClass}>{errors.receiverEmail.message}</p>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          {errors.receiverAddress && (
            <p className={errorClass}>{errors.receiverAddress.message}</p>
          )}
        </div>
      </div>
