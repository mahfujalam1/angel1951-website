  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <div className="relative group">
          <select
            ...
            className="w-full h-12 px-4 rounded-xl border border-[#E5E7EB] outline-none bg-white focus:border-[#1A3BDB] focus:ring-4 focus:ring-[#1A3BDB]/5 transition-all text-sm font-semibold appearance-none cursor-pointer"
          >
      ...
      <div className="flex gap-3 mb-5">
        <Button
          variant="outline"
          className="flex-1 h-11 gap-2 border-[#E5E7EB]"
        >
