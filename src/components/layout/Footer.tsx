...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1A3BDB] text-white">
      {/* ── Main Content ── */}
      <div className="max-w-[1800px] mx-auto px-10 pt-14 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_2fr] gap-12">
          {/* Brand */}
          <div>
            <div className="flex items-center mb-4">
              <div className="w-16 h-16 bg-white px-2 rounded-[8px] flex items-center justify-center">
                <img
            ...
            <ul className="flex flex-col gap-3">
              {usefulLinks.map((link) => (
                <li key={link.label}>
                  ...
                  >
                    <span className="text-[#F5A623] text-base leading-none">
                      →
                    </span>
                    {link.label}
                  </Link>
